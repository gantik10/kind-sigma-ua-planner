...
Локальний планер запуску українського акаунту @kindsigma.ua — **24 пости, зібрані виключно з наявних фото/відео**.

## Що всередині

- **Дроп · 6 липня** — 3 пости, що засівають фід (GENESIS, HALIA, HALIA off-duty)
- **Далі — пост кожні 2–3 дні** (9 лип → 28 сер): 21 пост
- Схожі серії (вулиця, яхта, сцена, вечірка) — окремі пости; справжні серії та продуктові герої — каруселі
...
Розклад публікацій: Дроп 6 лип (p1–p3), далі 9 · 12 · 14 · 17 · 19 · 22 · 24 · 27 · 29 лип · 1 · 3 · 6 · 8 · 11 · 13 · 16 · 18 · 21 · 23 · 26 · 28 сер.
